                ...
                <section className="card-soft p-5">
                  ...
                  <dl className="mt-3 space-y-2 text-sm">
                    ...
                    <div className="flex justify-between items-center"><dt className="text-muted-foreground">Reference</dt>
                      <dd className="flex items-center gap-2 font-mono font-medium">MB-{data.order.short_code} <button onClick={() => copy(`MB-${data.order.short_code}`)}><Copy className="h-3.5 w-3.5 text-muted-foreground" /></button></dd>
                    </div>
                  </dl>
